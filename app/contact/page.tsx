                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-r from-[#5D1F73] to-[#1ABC9C] rounded-2xl p-6 text-white">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <a href="https://www.linkedin.com/company/fusionedgeservices/" className="w-12 h-12 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition-all duration-300 hover:scale-110">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
